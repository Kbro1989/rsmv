...
exports.materialCacheKey = materialCacheKey;
...
function convertMaterial(data, materialid, source) {
    let rawparsed = opdecoder_1.parse.materials.read(data, source);
    ...
    if (rawparsed.v0) {
        ...
        if (raw.extra) {
            ...
            mat.baseColor = (raw.extra.baseColor == 0 ? [1, 1, 1] : (0, utils_1.HSL2RGBfloat)((0, utils_1.packedHSL2HSL)(raw.extra.baseColor)));
        }
