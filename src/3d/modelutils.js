...
exports.topdown2dWallModels = exports.classicRoof17 = exports.classicRoof16 = exports.classicRoof15 = exports.classicRoof14 = exports.classicRoof13 = exports.classicRoof12 = exports.classicRoof10 = exports.classicWallDiag = exports.classicWall = exports.materialPreviewCube = exports.ModelBuilder = exports.MeshBuilder = void 0;
exports.getAttributeBackingStore = getAttributeBackingStore;
exports.computePartialNormals = computePartialNormals;
...
class MeshBuilder {
    ...
    addParallelogram(col, v0, v1, v2) {
        ...
        this.index.push(this.vertindex + 0, this.vertindex + 2, this.vertindex + 1, this.vertindex + 0, this.vertindex + 3, this.vertindex + 2);
        this.vertindex += 4;
        return this;
    }
    ...
    convertSubmesh(matid) {
        let indices = new three_1.BufferAttribute(new Uint16Array(this.index), 1);
        return {
            indices,
            vertexstart: 0,
            vertexend: this.pos.length / 3 | 0,
            attributes: {
                pos: new three_1.BufferAttribute(new Float32Array(this.pos), 3),
                color: new three_1.BufferAttribute(new Uint8Array(this.color), 3, true),
                texuvs: new three_1.BufferAttribute(new Float32Array(this.uvs), 2),
                normals: new three_1.BufferAttribute(new Float32Array(this.normals), 3)
            },
            indexLODs: [indices],
...
function getAttributeBackingStore(attr) {
    if (attr instanceof three_1.InterleavedBufferAttribute) {
...
exports.materialPreviewCube = new ModelBuilder()
    .mat(0).addCube(white, [0, 300, 0], [600, 600, 600])
    .convert();
exports.classicWall = new ModelBuilder()
...
exports.classicRoof15 = new ModelBuilder()
    .mat(0).addTriangle(white, [halftile, rooftop, halftile], [-halftile, rooftop, -halftile], [-halftile, roofcorner, halftile])
    .mat(0).addTriangle(white, [-halftile, rooftop, -halftile], [halftile, rooftop, halftile], [halftile, roofcorner, -halftile])
    .convert();
//corner
exports.classicRoof16 = new ModelBuilder()
