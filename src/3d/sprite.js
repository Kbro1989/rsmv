...
exports.parseSubsprite = parseSubsprite;
exports.parseLegacySprite = parseLegacySprite;
exports.expandSprite = expandSprite;
exports.parseSprite = parseSprite;
exports.parseTgaSprite = parseTgaSprite;
exports.spriteHash = spriteHash;
...
function parseSubsprite(buf, palette, width, height, alpha, transposed) {
    ...
    return {
        img: (0, imgutils_1.makeImageData)(imgdata, width, height),
        bytesused: offset
    };
}
function parseLegacySprite(metafile, buf) {
    let file = new utils_1.Stream(buf);
    let metaoffset = file.readUShort(true);
    if (!metafile) {
        throw new Error("sprite meta file not found");
    }
    let meta = new utils_1.Stream(metafile);
...
function parseTgaSprite(file) {
    let str = new utils_1.Stream(file);
...
function spriteHash(img) {
    ...
    return (0, crc32util_1.crc32)(data);
}
