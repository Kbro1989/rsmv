...
exports.ParsedTexture = void 0;
const imgutils_1 = require("../imgutils");
const ddsimage_1 = require("./ddsimage");
class ParsedTexture {
    imagefiles;
    stripAlpha;
    isMaterialTexture;
        ...
        if (!res) {
            res = (async () => {
                ...
                if (this.type == "bmpmips") {
                    ...
                    return (0, imgutils_1.makeImageData)(imgdata.data, imgdata.width, imgdata.height);
                }
                else if (this.type == "png") {
                    return (0, imgutils_1.fileToImageData)(this.imagefiles[subimg], "image/png", this.stripAlpha);
                }
                else if (this.type == "dds") {
                    let imgdata = (0, ddsimage_1.loadDds)(this.imagefiles[subimg], padsize, this.stripAlpha);
                    return (0, imgutils_1.makeImageData)(imgdata.data, imgdata.width, imgdata.height);
                }
                else if (this.type == "ktx") {
                    let imgdata = (0, ddsimage_1.loadKtx)(this.imagefiles[subimg], padsize, this.stripAlpha);
                    return (0, imgutils_1.makeImageData)(imgdata.data, imgdata.width, imgdata.height);
                }
...
exports.ParsedTexture = ParsedTexture;
