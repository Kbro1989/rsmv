...
exports.pixelsToImageFile = pixelsToImageFile;
exports.fileToImageData = fileToImageData;
exports.pixelsToDataUrl = pixelsToDataUrl;
exports.isImageEqual = isImageEqual;
exports.maskImage = maskImage;
exports.isImageEmpty = isImageEmpty;
exports.canvasToImageFile = canvasToImageFile;
exports.flipImage = flipImage;
exports.sliceImage = sliceImage;
exports.findImageBounds = findImageBounds;
exports.dumpTexture = dumpTexture;
...
function makeImageData(data, width, height) {
    ...
    if (typeof ImageData != "undefined") {
        ...
        return { data: data, width, height, colorSpace: "srgb" };
    }
}
...
function isImageEqual(overlay, background, x1 = 0, y1 = 0, width = overlay.width, height = overlay.height) {
...
function isImageEmpty(img, mode, x1 = 0, y1 = 0, width = img.width, height = img.height) {
...
function sliceImage(img, bounds) {
...
function drawTexture(ctx, img) {
    ...
    if ("data" in img) {
        ...
        const sourceData = img.source.data;
