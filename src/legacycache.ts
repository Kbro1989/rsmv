import { CacheFileSource, SubFile } from "./cache/index";
import { EngineCache } from "./3d/modeltothree";
import { cacheFilenameHash, Stream } from "./utils";
import { legacybz2 } from "./cache/compression";
...
async function getLegacyImage(source: CacheFileSource, name: string, usetga: boolean) {
