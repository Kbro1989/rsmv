...
const typedef = commentJson.parse(readJsonc("./opcodes/typedef.jsonc")) as any;
...
function allParsers() {
	return {
		...
		npc: FileParser.fromJson<import("../generated/npcs").npcs>(readJsonc("./opcodes/npcs.jsonc")),
		item: FileParser.fromJson<import("../generated/items").items>(readJsonc("./opcodes/items.jsonc")),
		...
		mapsquareOverlays: FileParser.fromJson<import("../generated/mapsquare_overlays").mapsquare_overlays>(readJsonc("./opcodes/mapsquare_overlays.jsonc")),
		mapsquareLocations: FileParser.fromJson<import("../generated/mapsquare_locations").mapsquare_locations>(readJsonc("./opcodes/mapsquare_locations.json")),
		...
		frames: FileParser.fromJson<import("../generated/frames").frames>(readJsonc("./opcodes/frames.json")),
		animgroupConfigs: FileParser.fromJson<import("../generated/animgroupconfigs").animgroupconfigs>(readJsonc("./opcodes/animgroupconfigs.jsonc")),
		models: FileParser.fromJson<import("../generated/models").models>(readJsonc("./opcodes/models.jsonc")),
		oldmodels: FileParser.fromJson<import("../generated/oldmodels").oldmodels>(readJsonc("./opcodes/oldmodels.jsonc")),
		classicmodels: FileParser.fromJson<import("../generated/classicmodels").classicmodels>(readJsonc("./opcodes/classicmodels.jsonc")),
		spotAnims: FileParser.fromJson<import("../generated/spotanims").spotanims>(readJsonc("./opcodes/spotanims.json")),
		rootCacheIndex: FileParser.fromJson<import("../generated/rootcacheindex").rootcacheindex>(readJsonc("./opcodes/rootcacheindex.jsonc")),
		skeletalAnim: FileParser.fromJson<import("../generated/skeletalanim").skeletalanim>(readJsonc("./opcodes/skeletalanim.jsonc")),
		materials: FileParser.fromJson<import("../generated/materials").materials>(readJsonc("./opcodes/materials.jsonc")),
		...
		maplabels: FileParser.fromJson<import("../generated/maplabels").maplabels>(readJsonc("./opcodes/maplabels.jsonc")),
		cutscenes: FileParser.fromJson<import("../generated/cutscenes").cutscenes>(readJsonc("./opcodes/cutscenes.jsonc")),
		clientscript: FileParser.fromJson<import("../generated/clientscript").clientscript>(readJsonc("./opcodes/clientscript.jsonc")),
		clientscriptdata: FileParser.fromJson<import("../generated/clientscriptdata").clientscriptdata>(readJsonc("./opcodes/clientscriptdata.jsonc")),
		interfaces: FileParser.fromJson<import("../generated/interfaces").interfaces>(readJsonc("./opcodes/interfaces.jsonc")),
		dbtables: FileParser.fromJson<import("../generated/dbtables").dbtables>(readJsonc("./opcodes/dbtables.jsonc")),
		dbrows: FileParser.fromJson<import("../generated/dbrows").dbrows>(readJsonc("./opcodes/dbrows.jsonc"))
	}
}
=======
// import * as fs from "fs";
